...
start_button = Button(text="Start",font=(FONT_NAME, 12),bg="white", command=start_timer)
start_button.grid(column=0,row=2)

reset_button = Button(text="Reset",font=(FONT_NAME, 12),bg="white", command=reset_timer)
reset_button.grid(column=2,row=2)

checkmark_label = Label(text="",font=(FONT_NAME, 12),bg=YELLOW,fg=GREEN)
